    ...
    public partial class inthongtin : Form
    {
        ...
        public void thongtin(string a)
        {
            ...
            using (SqlConnection sqlConnection = connection.GetSqlConnection())
            {
                ...
                string query = "SELECT * FROM GiangVien WHERE maGiangVien = @a";
        ...
        public bool luu(String a)
        {
            using (SqlConnection sqlConnection = connection.GetSqlConnection())
            {
                ...
                string sqlUpdateQuery = "UPDATE giangvien SET tengiangvien = @Value1, ngaysinh = @Value2 ,gioitinh=@value3 ,diachi=@value4,sdt=@value5,email=@value6 WHERE magiangvien = @a";
